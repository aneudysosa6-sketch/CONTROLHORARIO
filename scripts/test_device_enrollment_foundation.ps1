...
Assert-Contains $config '^\[functions\.device-enrollment\]$' 'configuracion de device-enrollment'
Assert-Contains $config '^verify_jwt = false$' 'canje publico permitido en gateway'
