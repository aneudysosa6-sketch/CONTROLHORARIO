...
Has 'gradle.properties' '^CONTROLHORARIO_DEVICE_ENROLLMENT_URL=https://ertuneccoseqpbkubuet\.supabase\.co/functions/v1/device-enrollment$' 'URL HTTPS de STAGING'
...
Has 'app/src/main/java/com/example/controlhorario/device/EmployeeSyncWorker.kt' 'getString\(R\.string\.employee_sync_url\)' 'employee-sync carga URL en runtime'
