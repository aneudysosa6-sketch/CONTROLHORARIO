...
select has_column('public','empleados','fecha_desvinculacion','fecha_desvinculacion exists');
select has_column('public','empleados','motivo_desvinculacion','motivo_desvinculacion exists');
select has_column('public','empleados','observacion_desvinculacion','observacion_desvinculacion exists');
select has_column('public','empleados','desvinculado_por','desvinculado_por exists');
select has_column('public','empleados','actualizado_por','actualizado_por exists');
select has_table('public','empleado_ciclo_laboral_auditoria','employee lifecycle audit exists');
...
insert into public.jornada_eventos(
  ...
  idempotency_key,origen,payload
) values (
  ...
  jsonb_build_object('biometric_verified','true')
);
