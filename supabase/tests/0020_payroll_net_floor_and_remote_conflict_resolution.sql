...
select has_column('public', 'nomina_descuentos', 'monto_solicitado', 'monto solicitado se conserva');
select has_column('public', 'nomina_descuentos', 'monto_pendiente', 'monto pendiente se conserva');
