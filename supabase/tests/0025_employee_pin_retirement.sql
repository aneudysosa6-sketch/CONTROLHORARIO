...
select has_column('public', 'empleados', 'pin_hash', 'deprecated pin hash remains private');
select hasnt_column('public', 'empleados', 'pin_is_employee_code');
select hasnt_column('public', 'empleados', 'pin_configured');
select has_table('public', 'employee_pin_code_verification_audit', 'PIN verification audit exists');
