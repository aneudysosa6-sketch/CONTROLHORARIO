...
select has_table('public', 'face_first_enrollment_audit', 'face enrollment audit exists');
...
insert into public.empleados(
  ...
  ('23000000-0000-0000-0000-000000000031', '23000000-0000-0000-0000-000000000001', '23000000-0000-0000-0000-000000000011', '023001', 'Elegible Face', true, 'activo', true, null, null, null),
  ('23000000-0000-0000-0000-000000000032', '23000000-0000-0000-0000-000000000001', '23000000-0000-0000-0000-000000000011', '023002', 'Face Existente', true, 'activo', true, (select jsonb_agg(0.5) from generate_series(1,128)), null, null),
  ('23000000-0000-0000-0000-000000000033', '23000000-0000-0000-0000-000000000001', '23000000-0000-0000-0000-000000000012', '023003', 'Otra Sucursal', true, 'activo', true, null, null, null),
  ('23000000-0000-0000-0000-000000000034', '23000000-0000-0000-0000-000000000001', '23000000-0000-0000-0000-000000000011', '023004', 'Empleado Inactivo', false, 'desvinculado', false, null, current_date, 'Fixture de empleado inactivo'),
  ('23000000-0000-0000-0000-000000000035', '23000000-0000-0000-0000-000000000001', '23000000-0000-0000-0000-000000000011', '023005', 'Jornada Deshabilitada', true, 'activo', false, null, null, null);
