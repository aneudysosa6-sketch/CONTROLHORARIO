...
export const navigationItems:NavigationItem[]=[
 {to:'/dashboard',label:'Dashboard',section:'Inicio',permission:'dashboard.view',icon:LayoutDashboard},
 ...
 {to:'/eventos',label:'Eventos e incidencias',section:'Tiempo',permission:'eventos.view',icon:AlertTriangle},
 ...
 {to:'/empleados',label:'Empleados',section:'Personal',permission:'empleados.view',icon:Users},
 {to:'/supervisores',label:'Supervisores',section:'Personal',permission:'supervisores.view',icon:UserCog},
 ...
 {to:'/reportes',label:'Reportes',section:'Reportes',permission:'reportes.ver',icon:FileBarChart},
 {to:'/administracion',label:'Administración del sistema',section:'Administración',permission:'configuracion.ver',icon:Settings},
 {to:'/empresas',label:'Empresas',section:'Administración',permission:'empresas.view',icon:Settings},
 {to:'/sucursales',label:'Sucursales',section:'Administración',permission:'sucursales.view',icon:Settings},
 {to:'/departamentos',label:'Departamentos',section:'Administración',permission:'departamentos.view',icon:Settings},
 {to:'/usuarios',label:'Usuarios',section:'Administración',permission:'usuarios.view',icon:UserCog},
