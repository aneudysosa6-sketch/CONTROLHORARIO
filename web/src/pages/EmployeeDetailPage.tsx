...
import { ArrowLeft, Pencil, RotateCcw, UserMinus } from 'lucide-react';
...
import { FaceEnrollmentCard } from '../modules/face-enrollment/FaceEnrollmentCard';
...
export function EmployeeDetailPage() {
  ...
  return <>
    ...
    <FaceEnrollmentCard
      ...
      canInvite={hasPermission('empleados.biometria_invitar')}
      disabled={terminated}
