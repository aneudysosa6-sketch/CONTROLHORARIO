...
import { BlacklistPage, LicensesPage, NoPayPage, PriorAdjustmentsPage } from './pages/P0OperationsPages';
  ...
  return <Routes>
    ...
    <Route element={<Protected />}>
      ...
      <Route element={<AdminLayout />}>
        ...
        <Route path="/jornadas/incompletas" element={<RequirePermission permission="jornadas.resolver_incompletas"><NoPayPage /></RequirePermission>} />
        <Route path="/licencias" element={<RequirePermission permission="licencias.ver"><LicensesPage /></RequirePermission>} />
        ...
        <Route path="/nomina/ajustes-anteriores" element={<RequirePermission permission="nomina.ajustes_anteriores"><PriorAdjustmentsPage /></RequirePermission>} />
        ...
        <Route path="/administracion/mensajes" element={<RequirePermission permission="mensajes.administrar"><EmployeeMessagesPage /></RequirePermission>} />
        ...
        <Route path="/mensajes" element={<Navigate to="/administracion/mensajes" replace />} />
        ...
        <Route path="/reportes/lista-negra" element={<RequirePermission permission="lista_negra.ver"><BlacklistPage /></RequirePermission>} />
