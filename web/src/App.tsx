...
export default function App(){return <Routes>
 ...
 <Route element={<Protected/>}><Route path="/acceso-denegado" element={<AccessDeniedPage/>}/><Route element={<AdminLayout/>}>
  ...
  <Route path="/reportes" element={<RequirePermission permission="reportes.ver_globales"><ReportsPage/></RequirePermission>}/><Route path="/nomina" element={<RequirePermission permission="nomina.ver"><PayrollPage/></RequirePermission>}/>
