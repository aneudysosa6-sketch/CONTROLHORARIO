...
export function createPermissionReader(codes?:Iterable<string>):PermissionReader{if(!codes)return{has:()=>true};const allowed=new Set(codes);return{has:p=>allowed.has(p)}}
