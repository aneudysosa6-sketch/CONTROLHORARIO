...
const template=XLSX.utils.aoa_to_sheet([exactHeaders,['000001','Empleado Prueba',0,125,0]]);
...
XLSX.utils.book_append_sheet(book,XLSX.utils.aoa_to_sheet([['Código','Neto'],['000001',1000]]),'Detalle');
