...
class EmployeeEditEngineTest{
 @Test fun `editar Aneudy conserva identidad pin y huella sin crear otro empleado`(){
  ...
  val edited=EmployeeEditEngine.merge(aneudy,EmployeeEditableFields("Aneudy Sosa Valdez","001-0000000-1","8095550101","","Supervisor","Operaciones",2,3,50000.0,1.0),1000)
