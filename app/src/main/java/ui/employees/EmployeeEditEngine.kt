...
data class EmployeeEditableFields(
 val codePin:String,val nombre:String,val cedula:String,val telefono:String,val profilePhotoUri:String,
...
object EmployeeEditEngine{
 ...
 fun fieldsFrom(employee:Employee)=EmployeeEditableFields(employee.pin.ifBlank{employee.employeeCode},employee.nombre,employee.cedula,employee.telefono,employee.profilePhotoUri,employee.cargo,employee.departamento,employee.branchId,employee.departmentId,employee.sueldo,employee.lunchHours)
 fun merge(existing:Employee,fields:EmployeeEditableFields,updatedAt:Long=System.currentTimeMillis())=existing.copy(
  employeeCode=fields.codePin,pin=fields.codePin,nombre=fields.nombre,cedula=fields.cedula,telefono=fields.telefono,profilePhotoUri=fields.profilePhotoUri,
