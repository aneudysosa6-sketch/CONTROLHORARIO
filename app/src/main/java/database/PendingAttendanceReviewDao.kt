...
interface PendingAttendanceReviewDao {
    ...
    @Query("""UPDATE pending_attendance_reviews SET status=:status,calculatedHours=:calculatedHours,
        adminNote=:note,reviewedBy=:reviewedBy,reviewedAt=:reviewedAt,updatedAt=:updatedAt
