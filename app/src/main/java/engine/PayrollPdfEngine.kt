...
object PayrollPdfEngine {
    ...
    private fun saveWithMediaStore(
        ...
        val contentValues = ContentValues().apply {
            ...
            put(
                ...
                Environment.DIRECTORY_DOWNLOADS + "/CONTROL HORARIO/Nominas"
            )
        ...
        return PdfGenerationResult(
            success = true,
            fileName = fileName,
            displayPath = "Descargas/CONTROL HORARIO/Nominas/$fileName"
        )
    }
    ...
    private fun saveLegacy(
        ...
        val osinetFolder = File(downloadsFolder, "CONTROL HORARIO/Nominas")
    ...
    private fun drawReceipt(
        ...
        canvas.drawText(
            company?.companyName?.ifBlank { "CONTROL HORARIO" } ?: "CONTROL HORARIO",
            40f,
            y,
            titlePaint
        )
