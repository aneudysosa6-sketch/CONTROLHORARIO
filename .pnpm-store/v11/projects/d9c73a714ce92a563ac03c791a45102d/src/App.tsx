...
export default function App(){return <Routes>
 ...
 <Route element={<Protected/>}><Route path="/acceso-denegado" element={<AccessDeniedPage/>}/><Route element={<EmployeeLayout/>}><Route path="/mi-portal" element={<RequireEmployee><EmployeePortalPage/></RequireEmployee>}/></Route><Route element={<AdminLayout/>}>
  ...
  <Route path="/reportes" element={<RequirePermission permission="reportes.ver_globales"><ReportsPage/></RequirePermission>}/><Route path="/nomina" element={<RequirePermission permission="nomina.ver"><PayrollPage/></RequirePermission>}/><Route path="/nomina/solicitudes" element={<RequirePermission permission="prestamos.solicitudes_ver"><LoanRequestsPage/></RequirePermission>}/>
