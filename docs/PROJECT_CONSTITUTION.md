...
## Rol canonico y Terminal Android

La Web es la única superficie administrativa. Android es un Terminal cerrado para enrolamiento facial presencial y registro de INICIAR, PAUSA, REANUDAR y FINALIZAR mediante una credencial de dispositivo autorizada. Ningún usuario Web, teléfono personal ni token QR adquiere capacidad de Terminal. Esta regla prevalece sobre descripciones históricas incompatibles.
