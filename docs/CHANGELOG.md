...
## 2026-08-25 - Registro facial exclusivo del Terminal Android

### Cambiado

- El alta facial pasó de QR/teléfono personal al Terminal Android autorizado.
- La cámara muestra el botón de pendientes únicamente cuando el conteo servidor es mayor que cero.
- Captura frontal/izquierda/derecha, parpadeo, FaceNet-128 y confirmación online firmada P-256.

### Seguridad

- Migración aditiva 0060; 0055 a 0059 permanecen inmutables.
- QR pendientes revocados y RPC históricos bloqueados.
- Duplicidad, alcance, horario, día libre e idempotencia se validan atómicamente.
- Web conserva solo estado facial y reset con permiso/alcance.
...
## 2026-08-26 - Candidato final terminal-only

- Consolidado Android como Terminal exclusivo sin Login ni módulos administrativos.
- Validado enrolamiento facial presencial, reconocimiento, liveness y ciclo completo de jornada en WP23 Plus.
- Confirmadas las cuatro locuciones TTS mediante la misma ruta productiva.
- Retirado e inutilizado el flujo QR facial Web.
- Corregida la semántica de `face_match_margin`: nullable y opcional, sin cambiar threshold.
- Documentada la separación definitiva entre administración Web y operación del Terminal.
